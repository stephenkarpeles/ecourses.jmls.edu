                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            ...
                            <td><input type="text" size="80"  name="act_hdpath" value="<?php echo $act_hdpath ?>" />
                                <br /><?php _e('Enter the URL to HD video file', 'hdflv') ?></td>
                        </tr>
                        <tr valign="top">
...
?>
            ...
            <div id="post-body" class="has-sidebar"><br>
                ...
                <p><input type="submit" name="add_media" class="button-primary" onclick="return validateInput();" value="<?php _e('Add video file', 'hdflv'); ?>" class="button" /><input type="submit" class="button-secondary" name="cancel" value="<?php _e('Cancel'); ?>" class="button" /></p>
            </div>
        </div><!--END Poststuff -->
...
?>
            ...
            ?></h3>
                        ...
                        <?php
                                    if ($this->mode == 'playlist')
                                        echo '<input type="submit" name="add_playlist" value="' . __('Add Playlist', 'hdflv') . '" class="button-primary" />';
                                    if ($this->mode == 'plyedit')
...
?>
                                    <select name="plfilter">
                                        ...
                                        echo 'selected="selected"'; ?>><?php _e('--Playlist--', 'hdflv'); ?></option>
                            <option value="no" <?php if ($plfilter == 'no')
                                        echo 'selected="selected"'; ?>><?php _e('No playlist', 'hdflv'); ?></option>
            <?php
